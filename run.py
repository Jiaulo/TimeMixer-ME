...
parser = argparse.ArgumentParser(description='TimeMixer_ME')
...
# MTMEM parameters
parser.add_argument('--num_memories', type=int, default=32, help='size of memory bank in MTMEM')
parser.add_argument('--causal_levels', type=int, default=4, help='number of causal levels in MTMEM')
